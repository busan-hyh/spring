...
<html>
	...
	<body>
		<div id="member">
			<section class="login">		
				<form action="/hyh/login" method="post">
					<table>
						<tr>
							<td><img src="/hyh/img/login_ico_id.png" alt="아이디" /></td>
							<td><input type="text" name="uid" required placeholder="아이디 입력" autocomplete="off" /></td>
						</tr>
						<tr>
							<td><img src="/hyh/img/login_ico_pw.png" alt="비밀번호" /></td>
				...
				<div class="info">
					...
					<div><a href="/hyh/terms">회원가입</a></div>
				</div>			
			</section>
		</div>
