        ...
        <div class="uploadrCard">
            <form action="/cz/modify?seq=${ view.seq }" method="POST">
                <table id="main">
                    ...
                    <tr>
                        <td>상세주소</td>
                        <td colspan="2"><input type="text" name="detail_addr" value="${ view.detail_addr }"></td>
                    </tr>
                    <tr>
                        <td>크기</td>
                        <td colspan="2"><input type="text" class="mSMeter" name="scale_meter" value="${ view.scale_meter }">㎡ = <input type="text" class="mPyung" name="scale_pyung" value="${ view.scale_pyung }"></span>평</td>
                    </tr>
                    <tr>
                        <td>메모</td>
                ...
                <table id="forSale">
                    <tr>
                        ...
                        <td colspan="2"><input type="text" name="sale_money_int" value="${ view.sale_money_int }">
                            <select name="sale_money_unit" id="salemoney">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><input type="text" name="sale_jeonse_money_int" value="${ view.sale_jeonse_money_int }">
                            <select name="sale_jeonse_money_unit" id="salemoney">
                ...
                <table id="forJeonse">
                    <tr>
                        ...
                        <td><input type="text" name="jeonse_money_int" value="${ view.jeonse_money_int }">
                            <select name="jeonse_money_unit" id="salemoney">
                                <option value="10000">억원</option>
                                <option value="1000" selected>천만원</option>
                                <option value="100">백만원</option>
                                <option value="10">십만원</option>
                ...
                <table id="forRent">
                    <tr>
                        ...
                        <td><input type="text" name="rent_save_int" value="${ view.rent_save_int }">
                            <select name="rent_save_unit" id="salemoney">
                                <option value="10000">억원</option>
                                <option value="1000" selected>천만원</option>
                                <option value="100">백만원</option>
                                <option value="10">십만원</option>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="rent_int" value="${ view.rent_int }">
                            <select name="rent_unit" id="salemoney">
                                <option value="100">백만원</option>
                ...
                <table id="connect">
                    ...
                    <tr>
                        <td><input type="hidden" name="mng2_kind" value="1">담당자</td></td>
                    ...
                    <tr>
                        ...
                        <td><input name="slr2_name" type="text" value="${ view.slr2_name }"></td>
                        <td><input name="slr2_hp" type="text" value="${ view.slr2_hp }"></td>
