...
<body>
    <div class="wrapper">
        <div class="uploadrCard">
            <form action="/cz/upload" method="POST">
                <table id="main">
                    <tr>
                    ...
                    <tr>
                        <td>상세주소</td>
                        <td colspan="2"><input type="text" name="detail_addr"></td>
                    </tr>
                    <tr>
                        <td>크기</td>
                        <td colspan="2"><input type="text" class="mSMeter" name="scale_meter" numberOnly>㎡ = <input type="text" class="mPyung" name="scale_pyung" numberOnly></span>평</td>
                    </tr>
                    <tr>
                        <td>메모</td>
